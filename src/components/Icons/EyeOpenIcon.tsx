...
const EyeOpenIcon: React.FC<EyeOpenIconProps> = ({ size = '20px', color = Colors.black, className }) => {
	return (
		<svg width={size} height={size} className={className} fill={color} viewBox="0 0 1024 1024">
			<path
